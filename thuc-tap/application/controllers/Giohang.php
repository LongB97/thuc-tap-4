...
class Giohang extends CI_Controller {
	...
	public function index(){
        $this->data['title']='Điện Tử Bách Việt - Giỏ hàng của bạn';
    ...
    public function checkout(){
        if($this->session->userdata('session24hStore')){
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $this->data['title']='Điện tử Bách Việt - Đặt hàng';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='Điện tử Bách Việt - Thông tin đơn hàng';
    ...
    public function thankyou(){
        ...
        $this->data['title']='Điện tử Bách Việt - Kết quả đơn hàng';
