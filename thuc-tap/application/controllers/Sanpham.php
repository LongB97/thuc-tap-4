...
class Sanpham extends CI_Controller {
	...
	public function index(){
        ...
        $this->data['title']='Điện tử Bách Việt - Tất cả sản phẩm';
    ...
    public function category(){
        ...
        $this->data['list']=$li;
        $this->data['title']='Điện tử Bách Việt - Sản phẩm theo từng danh mục';  
    ...
    public function detail($link){   
        ...
        $this->data['row']=$row;
        $this->data['title']='Điện tử Bách Việt - '.$row['name'];  
